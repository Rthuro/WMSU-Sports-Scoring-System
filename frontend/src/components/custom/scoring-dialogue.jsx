    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[400px]">
        ...
        <div className="flex flex-col gap-4 ">
          <Link to={adminRoute(`Sports/${sport?.name}/scoring`)} className="text-left border rounded-lg p-3  w-[350px] bg-zinc-900 text-white flex flex-col gap-2 hover:bg-zinc-800 shadow-md">
          ...
          <Link to={adminRoute(`Sports/${sport?.name}/match`)} className="text-left w-[350px] border rounded-lg p-3 flex flex-col gap-2 hover:bg-zinc-100">

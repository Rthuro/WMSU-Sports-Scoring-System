...
export function ManageTournament() {
    ...
    const [bracketType, setBracketType] = useState("all");

    const sort_tournaments = () => {
        if (bracketType === "all") {
            return tournaments;
        }
        return tournaments.filter(t => t.bracketing === bracketType);
    }
    ...
    return <>
        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
                <Select value={bracketType} onValueChange={(e) => setBracketType(e)}>
                    ...
                    <SelectContent>
                        <SelectGroup>
                            ...
                            {Array.from(new Set(tournaments.map(t => t.bracketing).filter(Boolean))).map(type => (

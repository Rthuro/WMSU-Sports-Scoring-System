...
ALTER TABLE matches ADD COLUMN IF NOT EXISTS player_a_id UUID REFERENCES players(player_id) ON DELETE SET NULL;
ALTER TABLE matches ADD COLUMN IF NOT EXISTS player_b_id UUID REFERENCES players(player_id) ON DELETE SET NULL;
ALTER TABLE matches ADD COLUMN IF NOT EXISTS team_a_id INT REFERENCES teams(team_id) ON DELETE SET NULL;
ALTER TABLE matches ADD COLUMN IF NOT EXISTS team_b_id INT REFERENCES teams(team_id) ON DELETE SET NULL;
